...
/**
 * Servlet that handles server requests made to "/view_artist" URL.
 */
@WebServlet("/view_artist")
public class ViewAlbumsByArtistServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public ViewAlbumsByArtistServlet() {
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		albumServices.listAlbumsByArtist();
	}
